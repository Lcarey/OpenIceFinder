...
const CANDIDATES: Candidate[] = [
  ...
  },
  {
    ...
    notes: "Tue/Thu public skate from the last published 2025–26 Watertown Rec season. RecTimes does not label public sessions.",
    source: {
      kind: "weekly-hours",
      seasonStart: "2026-11-03",
      seasonEnd: "2027-04-08",
      sessions: [{ title: "Public Skating", days: [2, 4], start: "11:00", end: "13:00" }],
    },
  },
  {
    id: "hayden-lexington",
  ...
  },
  {
    ...
    notes: "Sunday public skate from the last published Woburn Rec winter schedule. Confirm at woburnrec.com before you go.",
    source: {
      kind: "weekly-hours",
      seasonStart: "2026-10-04",
      seasonEnd: "2027-03-29",
      sessions: [{ title: "Public Skating", days: [0], start: "9:20", end: "10:20" }],
    },
  },
  {
    id: "daly-brighton",
  ...
  },
  {
    ...
    source: { kind: "finnly", baseUrl: "https://warrior.finnlyconnect.com", scheduleIds: [20, 19] },
  },
  {
    id: "veterans-waltham",
    emoji: "⌚",
  ...
  },
  {
    ...
    operator: "DCR",
    notes: "Hours from the last published DCR 2025–26 schedule. Public skate typically starts the Friday after Thanksgiving; stick time is cancelled during school vacation weeks.",
    source: {
      kind: "weekly-hours",
      seasonStart: "2026-11-28",
      seasonEnd: "2027-04-11",
      sessions: [
        { title: "Public Skating", days: [0, 6], start: "14:00", end: "15:50" },
        { title: "Public Skating", days: [2, 4, 5], start: "12:00", end: "13:50" },
  ...
  },
  {
    ...
    source: {
      ...
      seasonEnd: "2027-04-11",
      sessions: [
        { title: "Public Skating", days: [0], start: "15:00", end: "18:50" },
        { title: "Public Skating", days: [1, 2, 4], start: "12:00", end: "14:20" },
        { title: "Public Skating", days: [3], start: "12:00", end: "14:50" },
        { title: "Public Skating", days: [5], start: "12:00", end: "15:50" },
        { title: "Public Skating", days: [5], start: "19:00", end: "21:50" },
        { title: "Public Skating", days: [6], start: "16:00", end: "21:50" },
        { title: "Public Stick Time", days: [3], start: "10:00", end: "11:50", skipSchoolVacations: true },
      ],
    },
  },
  {
    ...
    source: {
      ...
      sessions: [
        ...
        { title: "Public Skating", days: [2, 4, 5], start: "12:00", end: "14:20" },
        { title: "Public Stick Time", days: [3], start: "12:00", end: "13:50", skipSchoolVacations: true },
      ],
    },
  },
  ...
  },
  {
    ...
    operator: "MPG Arena",
    notes: "Private facility; no drop-in public calendar is published. Wilmington Youth Hockey runs learn-to-skate / learn-to-play by session.",
    source: { kind: "link-only", reason: "No machine-readable public calendar. Check wilmingtonyouthhockey.org for LTS/LTP sessions." },
  },
  {
